...
public class ERP_Functions {
	...
	public static String verifySupplier(String sname, String address, String city, String country, String cperson,
		...
		driver.findElement(By
				.xpath("//div[@class='panel-heading ewGridUpperPanel']//span[@class='glyphicon glyphicon-plus ewIcon']"))
				.click();
		// Thread.sleep(4000);
		...
		String Act_data = driver
				.findElement(By.xpath("//table[@id='tbl_a_supplierslist']/tbody/tr[1]/td[6]/div/span/span")).getText();
		// Thread.sleep(4000);
	 ...
	 * ERP_Functions.verifyIogin("admin", "master");
	 * ERP_Functions.verifySupplier("Devesh", "ABD", "HYD", "India", "2345",
	 * "3456", "Dev@gmail.com", "34456", "xyz"); ERP_Functions.verifylogout(); }
	 */
